...
在本实验室中，你将在 Azure AD 中注册应用程序，添加用户，然后测试该用户对该应用程序的访问权限，验证 Azure AD 是否可保护该应用。 你还将使用 Graph 浏览器工具生成针对 Azure AD 用户帐户的图形 API 的请求并对其进行测试。
