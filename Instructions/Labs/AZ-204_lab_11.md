...
### <a name="exercise-4-application-insights-logging-with-net"></a>练习 4：.NET 的 Application Insights 日志记录

#### <a name="task-1-configure-logging-for-a-net-api-app"></a>任务 1：配置 .NET API 应用的日志记录
