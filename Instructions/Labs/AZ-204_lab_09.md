...
1. 在 Program.cs 文件的 Main 方法中添加以下代码：
    ...
    ```
    > **备注**：若要了解有关 **[AzureKeyCredential](https://docs.microsoft.com/dotnet/api/azure.azurekeycredential)** 的详细信息
  
    > **备注**：若要了解有关事件网格的详细信息，请单击以下链接： 
