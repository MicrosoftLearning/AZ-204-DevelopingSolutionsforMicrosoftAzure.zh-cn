...
1. 运行以下命令，从 NuGet 导入 Azure.Messaging.EventGrid 版本 4.11.0：
    ...
    > 注意：dotnet add package 命令将从 NuGet 添加 Azure.Messaging.EventGrid 包  。 有关详细信息，请转到 [Azure.Messaging.EventGrid](https://www.nuget.org/packages/Azure.Messaging.EventGrid/4.11.0)。
...
#### <a name="task-3-publish-new-events"></a>任务 3：发布新事件
