...
> **活动订阅**：如果有多个活动订阅。 你始终可以通过使用命令中的 subscription 参数来指定要在其中执行命令的订阅。 请访问此处，详细了解如何使用 [Azure CLI](https://docs.microsoft.com/en-us/cli/azure/manage-azure-subscriptions-azure-cli)、[Azure PowerShell](https://docs.microsoft.com/en-us/powershell/azure/azurerm/manage-subscriptions-azureps?view=azurermps-6.13.0) 管理订阅
