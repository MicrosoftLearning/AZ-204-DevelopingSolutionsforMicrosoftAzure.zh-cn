...
1.  确保 `Microsoft.AspNetCore.Authentication.JwtBearer` 和 `Microsoft.AspNetCore.Authentication.OpenIdConnect` NuGet 包的版本设置为“6.0.6”。

1.  将 `Microsoft.Identity.Web` 和 `Microsoft.Identity.Web.UI` NuGet 包的版本设置为“1.25.0”。
