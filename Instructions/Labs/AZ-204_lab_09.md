...
1. 在 Azure 门户中，选择“Cloud Shell”图标 ![Cloud Shell 图标](./media/az204_lab_CloudShell.png) 打开 Cloud Shell****。 如果 Cloud Shell 默认为 PowerShell 会话，请在“Cloud Shell”菜单中选择“切换到 Bash”，然后选择“确认”************。
    ...
    如果这是你首次启动 Cloud Shell，你将看到一系列创建资源的提示****。 执行下表中所述的操作：

    | 提示 | 操作 |
    |--|--|
    | 欢迎使用 Azure Cloud Shell | 选择 **Bash**。 |
    | 入门 | 选择“装载存储帐户”，然后从下拉列表中选择你的存储帐户订阅，最后选择“应用”************。 |
    | 装载存储帐户 | 选择“我们将为你创建一个存储帐户”，然后选择“下一步”********。 |
...
1. 在“创建 Web 应用”边栏选项卡的“基本”选项卡上，执行以下操作，然后选择“Docker”选项卡：************
